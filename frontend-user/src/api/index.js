...
export const recommendProducts = [
  ...
  { id: 3, name: '小米14 Ultra 徕卡光学镜头 骁龙8Gen3', price: 6499, originalPrice: 6999, sales: 8765, image: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=300&h=300&fit=crop', shop: '小米官方旗舰店' },
  { id: 4, name: '华为MateBook X Pro 2024款超轻薄笔记本', price: 11999, originalPrice: 12999, sales: 3456, image: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=300&h=300&fit=crop', shop: '华为官方旗舰店' },
  { id: 5, name: '耐克Air Jordan 1 High OG 复刻运动鞋篮球鞋', price: 1299, originalPrice: 1599, sales: 9876, image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=300&h=300&fit=crop', shop: 'Nike官方旗舰店' },
  { id: 6, name: '香氛精华香味清新持久 30ml', price: 88, originalPrice: 280, sales: 15678, image: 'https://images.unsplash.com/photo-1617897903246-719242758050?w=300&h=300&fit=crop', shop: '花漾官方旗舰店' },
  { id: 7, name: '戴森V15 Detect无绳吸尘器 激光探测', price: 4990, originalPrice: 5490, sales: 4567, image: 'https://images.unsplash.com/photo-1558317374-067fb5f30001?w=300&h=300&fit=crop', shop: '戴森官方旗舰店' },
  { id: 8, name: '索尼WH-1000XM5头戴式无线降噪耳机', price: 2499, originalPrice: 2999, sales: 7890, image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=300&h=300&fit=crop', shop: 'Sony官方旗舰店' }
]
