 ...
 * @returns {Object|null} 商品详情对象或null
 */
 ...
 */
export function searchProducts(keyword, minPrice = null, maxPrice = null) {
  let result = [...recommendProducts]
 ...
 * @returns {Array} 筛选后的商品列表
 */
export function filterProductsByPrice(minPrice = null, maxPrice = null) {
  let result = [...recommendProducts]
